/** The two languages this dashboard ships. Arabic exists in the RN apps and in
...
export const LOCALE_STORAGE_KEY = 'switch-finance.locale';
...
/**
 * The browser's own preference, used the first time someone opens the dashboard.
 *
