...
const ACCESS_OPTIONS: readonly { key: AccessFilter; label: string }[] = [
  { key: 'all', label: ACCESS_LABELS.all },
  { key: 'granted', label: ACCESS_LABELS.granted },
  { key: 'denied', label: ACCESS_LABELS.denied },
];
    ...
    <div className="flex flex-wrap items-center gap-2">
      ...
      >
        <SearchField.Group>
          ...
          <SearchField.Input placeholder="Search by username" />
